...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CerberusProvider) DeepCopyInto(out *CerberusProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
	if in.AdditionalRoles != nil {
		in, out := &in.AdditionalRoles, &out.AdditionalRoles
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CerberusProvider.
func (in *CerberusProvider) DeepCopy() *CerberusProvider {
	if in == nil {
		return nil
	}
	out := new(CerberusProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.Cerberus != nil {
		in, out := &in.Cerberus, &out.Cerberus
		*out = new(CerberusProvider)
		(*in).DeepCopyInto(*out)
	}
}
